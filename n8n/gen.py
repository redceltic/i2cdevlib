...
"// B2: Anwender-Eingaben (Formular) zaehlen als belegt; unbelegte Defaults senken die Konfidenz.\n"
"const belegtN = herkunft.filter(x => /belegt|Anwender-Eingabe/i.test(x.quelle)).length;\n"
...
"  implausibel, plausibilitaet, nutzen_label, belegt_anteil: Math.round(belegtAnteil*100)/100,\n"
...
"GoBD bei bestell-/rechnungs-/lieferungsnahen Daten (Bestelldaten speisen Rechnung/Lieferung): Default \"pruefen\" statt \"nicht einschlaegig\". "
