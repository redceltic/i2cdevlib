...
VERSION = "Build 2026-06-29 k (v1.4 C1 Prosa-Sperre)"   # Sichtbar im Dashboard (unten rechts) -> zeigt die geladene Version.
...
"// Optionale Treiber aus dem Formular (pro Kunde) -> Config gibt ihnen Vorrang vor den Defaults.\n"
